    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            if (displacementProgress < 0.3) {
                const easing = displacementProgress / 0.3
                screenX = controller.lerp(spiralPos.x, spiralPos.x + this.dx * 0.3, easing)
                screenY = controller.lerp(spiralPos.y, spiralPos.y + this.dy * 0.3, easing)
            ...
            const cZ = (controller as any)['cameraZ']
            const vZoom = (controller as any)['viewZoom']
            const vx = ((this.z - cZ) * screenX) / vZoom
            const vy = ((this.z - cZ) * screenY) / vZoom
